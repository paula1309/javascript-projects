function start() {
    ...
    function explosao1(inimigo1X,inimigo1Y) {
        ...
        var div=$("#explosao1");
        div.css("background-image", "url('assets/img/explosao.png')");
